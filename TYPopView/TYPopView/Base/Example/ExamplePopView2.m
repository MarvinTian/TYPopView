...
@interface ExamplePopView2  () <TYPopViewDelegate>

@end
@implementation ExamplePopView2

- (instancetype)init {
    return [[ExamplePopView2 alloc]initWithTopic:[[NSAttributedString alloc]initWithString:@"标题" attributes:@{
